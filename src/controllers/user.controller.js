...
const getUsedChannelProofile = asyncHandler(async (req , res) => {
...
const getWatchHistory = asyncHandler(async (req , res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, user[0].getWatchHistory,"watch History fetched succefully")
    )
})

export {registerUser , loginUser , logoutUser , refreshAccessToken , changeCurrentPassword , getCurrentUser , updateAccountDetails , updateUserAvatar ,updateUserCoverImage , getUsedChannelProofile , getWatchHistory}
